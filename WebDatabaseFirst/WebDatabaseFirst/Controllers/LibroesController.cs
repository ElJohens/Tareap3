...
namespace WebDatabaseFirst.Controllers
{
    public class LibroesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LibroId,NombreLibro,AutorLibro")] Libro libro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LibroId,NombreLibro,AutorLibro")] Libro libro)
        {
            if (id != libro.LibroId)
            {
                return NotFound();
